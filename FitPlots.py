...
print(DVCSxsec_HERA_theo([0.066355,0.0023,-0.8,3.937,13.3,1.906,"UU"], Para_Unp_All, Para_Pol_All))

print(CFF_theo(0.001188, -0.1, 2.828427, Para_Unp_All, Para_Pol_All))

print(CFF_theo(0.001188, -0.5, 2.828427, Para_Unp_All, Para_Pol_All))

print(CFF_theo(0.001188, -0.8, 2.828427, Para_Unp_All, Para_Pol_All))
