...
@vectorize(["float64(float64,float64,float64,float64,float64,complex128,complex128,complex128,complex128)"])        
def dsigma_Jpsi_dt_NLO(y: float, xB: float, t: float, Q: float, phi: float, HTFF_jpsi: complex, HTFF_NLO_jpsi: complex, ETFF_jpsi: complex, ETFF_NLO_jpsi: complex):
